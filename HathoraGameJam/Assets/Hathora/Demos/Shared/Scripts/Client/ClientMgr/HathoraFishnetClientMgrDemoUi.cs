...
namespace Hathora.Demos._1_FishNetDemo.HathoraScripts.Client.ClientMgr
{
    ...
    public class HathoraFishnetClientMgrDemoUi : HathoraClientMgrDemoUi, IHathoraNetClientMgrUi
    {
        ...
        private static HathoraClientMgrNGO hathoraClientMgrNGO =>
           HathoraClientMgrNGO.Singleton;
        ...
        {
            base.OnStart();
            InitOnStart(hathoraClientMgrNGO);
        }
        ...
        {
            Debug.Log("Custom - HathoraFishnetClientMgrDemoUi: OnStartClientBtnClick");
    ...
    //        HathoraClientMgrNGO.Singleton.StartClient(_hostPortOverride);
        ...
        {
            Debug.Log("Custom - HathoraFishnetClientMgrDemoUi: OnJoinRoomAsClientBtnClick: " + connectionInfo);
            base.OnJoinRoomAsClientBtnClick(connectionInfo);
            Connect();
        }

        public void Connect() =>
            HathoraClientMgrNGO.Singleton.ConnectAsClient();
